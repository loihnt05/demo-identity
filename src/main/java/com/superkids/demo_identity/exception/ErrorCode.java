...
public enum ErrorCode {
    ...
    USERNAME_INVALID(1002, "Username must contain at least {min} characters", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID(1003, "Password must contain at least {min} characters", HttpStatus.BAD_REQUEST),
    ...
    INVALID_DOB(1007, "Invalid date of birth, you must be at least {min}", HttpStatus.BAD_REQUEST),
    ;
